...
unset($__errorArgs, $__bag); ?>" name="title"
                                id="title" value="<?php echo e(old('title', $post->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="slug"
                                id="slug" value="<?php echo e(old('slug', $post->slug)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" id="body" name="body" value="<?php echo e(old('body', $post->body)); ?>">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Web\coba-laravel\resources\views/dashboard/posts/edit.blade.php ENDPATH**/ ?>